    ...
    conteudo: [
      {
        ...
        description: (
          <div>
            <Text content="Ainda jogando, mas essa foi uma das cenas bem triste"></Text>
          </div>
        ),
      ...
      },
      {
        ...
        description: (
          <Text
            content="Basicamente quando você está olhando para uma direção qualquer e
          ...
          pegar tudo que tem ao redor"></Text>
        ),
        media: {
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Atualmente tenho 47 horas de gameplay nessa obra de arte, na minha
              ...
              tutorial extreamente rico em história e contexto."></Text>

            <Text
              content="Para min um grande ponto negativo é o tempo imenso para que o jogo
              seja carregado, o que faz eu pensar duas vezes antes de abrir o
              jogo"></Text>

            <Text
              content="Eu gostei muito das teclas usadas, estava bem em cima onde meus
              dedos esperavam"></Text>

            <Text content="A ambientação é perfeita"></Text>

            <Text
              content="Tanto pela excelente dublagem em português, quanto pelo carinho
              ...
              claro, e a minha curiosidade avançava com a Aloy"></Text>

            <Text
              content="Possivelmente eu poderia ficar horas e horas elogiando esse jogo,
              ...
              arte, queria muito que mais pessoas experimentassem esse jogo."></Text>
          </section>
        ),
        media: {
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Embora o Cyberpunk 2077 seja notório pelos seus bugs, travamentos,
            ...
            <Text content="mais aprendizados"></Text>

            <Text
              content="O jogo nos apresenta um mundo Cyberpunk incrível na perspectiva de
            ...
            <Text
              content="Você pode escolher se será o V ou a V, no caso, um protagonista
              masculino ou feminino, isso impacta em algumas missões e trás uma
              experiência diferente principalmente em relacionamentos."></Text>

            <Text
              content="Além disso, como estamos no futuro, é bem comum implantes e
            ...
            <Text
              content="Isso pode ter permitir fazer um personagem que se pareça com você,
              ...
              foi a minha versão, e isso é muito legal para a imersão."></Text>

            <Text
              content="Vou evitar comentar de bugs aqui, pois o jogo tem e muitos, em
            ...
            <Text
              content="Infelizmente o jogo é bem limitado, por exemplo, não tem veículos
              aéreos facilmente usáveis, e nem um sistema de metro ou trem,
              mesmo isso existindo no jogo e sendo mostrado nos trailers do
              jogo."></Text>

            <Text
              content="O jogo também é problemático no quesito da inteligência
              artificial, no geral ela é bem fraca, e bugada em vários casos."></Text>

            <Text
              content="As relações com as pessoas são um ponto forte e fraco ao mesmo
            ...
            <Text
              content="Cyberpunk não é nem de longe uma história feliz, os finais tem
              ...
              fiz outros finais também."></Text>

            <Text
              content="A maior parte das coisas em Cyberpunk são pontos altos e baixos ao
              mesmo tempo, infelizmente, muito potencial foi desperdiçado, para
              min esse jogo poderia ser um dos melhores jogos já feitos,
              infelizmente, são muitos problemas."></Text>

            <Text
              content="Mesmo com todos esses problemas, eu acho que Cyberpunk merece um
      ...
      },
      {
        ...
        description: (
          <Text
            content="Torço demais para um cyberpunk 2, se eles tiverem aprendido, vai ser
          fácil o jogo do ano"></Text>
        ),
        media: {
          youtube: 'dd0XckIHKFY',
        },
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Se você está em busca de tranquilidade, talvez o Valorant não seja
              a melhor opção. No entanto, se você já aceitou que os jogos de FPS
              podem ser desafiadores às vezes, então pode valer a pena
              experimentá-lo."></Text>

            <Text
              content="O jogo é muito interessante e trás uma nova perspectiva para jogos
            ...
            <Text
              content="Valorant tem muitos inúmeros problemas com parte da comunidade, de
            ...
            <Text
              content="Mesmo com tudo isso, eu realmente gosto de Valorant, é o meu FPS
              favorito atualmente."></Text>

            <Text
              content="Na minha opinião, dou nota 10 ao Valorant pelo jogo em si
              descartando todos os problemas com a comunidade."></Text>
          </section>
        ),
        media: {
          imagem: Valorant,
      ...
      },
      {
        ...
        description: (
          <Text
            content="Esse foi um dos momentos mais insanos que acompanhei, foi
          maravilhosos ver isso ao vivo, sem palavras"></Text>
        ),
...

      {
        ...
        description: (
          <section>
            <Text
              content="Um dos melhores vídeos já feitos de Valorant, ele foi feito para o
              ...
              jogadores, e então vemos os jogadores controlando os agentes."></Text>
            <Text content="Eu não sou bom de explicações, mas esse vídeo é maravilhoso."></Text>
          </section>
        ),
        media: {
          youtube: 'h7MYJghRWt0',
      ...
      {
        title: 'Uma edição incrível do tteuw ENEMY 😈 (Valorant RADIANT montage)',
        description: '',
        media: {
          youtube: 'X2TSeT-0XyY',
        },
      ...
      {
        title: 'Mais uma edição maravilhosa do Beggin Zishu 🙏🔥 (Valorant Montage)',
        description: '',
        media: {
          youtube: 'vQqU0F8vTOE',
        },
      ...
      {
        title: 'Edição da RIOT GAMES perfeita com a Raze, feliz de mais heheh VALORANT | Raze - O que for bom!',
        description: '',
        media: {
          youtube: 'L36C5IoA0KA',
        },
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Tenho muito carinho por esse game, ele abriu os caminhos para esse
              estilo de jogo, é muito bem feito, tem personagens cativantes, um
              vilão insano."></Text>

            <Text
              content="Um dos aprendizados que tive é que você precisa de recompensar o
              ...
              foi uma sensação muito boa"></Text>

            <Text
              content="O final do jogo para min é muito ruim, já que deixa algumas coisas
              implícitas e não deixa a gente se certificar que acabou, o que não
              faz sentido nenhum considerando tudo o que o personagem passou."></Text>

            <Text
              content="Para min, esse é um jogo fantástico, tudo nele funciona muito bem
              (tirando o final), e para min é uma obra de arte também."></Text>

            <Text content="Para min, um 10, jogo muito bom, para a época, apesar do final"></Text>
          </section>
        ),
        media: {
          imagem: farcry3,
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Um dos meus jogos favoritos já lançados, e que conseguiu ficar
              ainda melhor com o tempo, principalmente com os canais brasileiros
              de GTA San Andreas."></Text>
            <Text
              content="Personagens incríveis, cenários extraordinários, radios
              maravilhosas, e um protagonista memorável e que provou que a
              Rockstar poderia superar o GTA 3 e os anteriores."></Text>
            <Text
              content="Até hoje (2023), o jogo é incrível, e recheado de coisas para
              fazer, o que tornam ainda melhor."></Text>

            <Text content="Para min, um 10, tanto para aquela época, quanto para a de 2023."></Text>
          </section>
        ),
        media: {
          imagem: gtasa,
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Este é um dos melhores jogos já feito na história, não
              considerando os jogos atuais, mas sim para a época dessa
              maravilha, ele revolucionou a industria de games e mesmo hoje eu
              tenho muitas boas lembranças dessa obra de arte."></Text>
            <Text
              content="O final é insano, e da uma conclusão para uma das melhores
              personagens do GTA San Andreas, lançado depois."></Text>
            <Text
              content="Para min, um 10, para a época dele, um jogo perfeito,
              ...
              considero o periodo que ele foi lançado e as limitações da época"></Text>
          </section>
        ),
        media: {
          imagem: gta3,
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Este jogo me trás muitas lembranças de raiva, pois, fui burro, e
              joguei a campanha toda no modo veterano, foi muito difícil para
              min nessa época, apanhei muito, mas consegui zera-lo."></Text>

            <Text
              content="A missão em Chernobyl mesmo, a qual ficamos cercados após o ataque
            ...
            <Text
              content="O jogo tem vários momentos de guerra e tem cenários incríveis, que
              ...
              real eu teria ido para o ralo no comecinho."></Text>

            <Text
              content="Para min, um 10, não é perfeito, mas tem seu publico e atende
              muito bem, meus problemas foram devido dificuldade que não me
              atentei, e tudo ficou mais complicado."></Text>
          </section>
        ),
        media: {
          imagem: cod4,
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Mais um jogo que tenho muito carinho, só fui jogar ele a pouco
              tempo em um emulador de PS2, e é um jogo maravilhoso e divertido"></Text>
            <Text
              content="Acho que a qualidade das musicas é um diferencial importante, pois
              a maioria das musicas são bem interessantes."></Text>
            <Text
              content="Os detalhes musicais foram bem feitos, mesmo que o clique meu
              ...
              que parece"></Text>
            <Text
              content="Recomendo começar com dificuldade baixa e ir evoluindo a cada vez
              que você zerar, pelo menos para min que não estava acostumado no
              controle, foi bem complicado no inicio até no fácil."></Text>
          </section>
        ),
        media: {
          imagem: guitarhero,
    ...
    conteudo: [
      {
        ...
        description: (
          <section>
            <Text
              content="Esse jogo na verdade não tem muita coisa em especial, mas, me
              atraiu muito o ambiente e personagem com suas habilidades insanas."></Text>

            <Text
              content="Consegui rodar esse game com todos os gráficos no mínimo, e em uma
              ...
              aguentava e crashava."></Text>

            <Text content="De qualquer forma, o jogo tem o seu valor e é incrível também."></Text>

            <Text
              content="Para min, um 7, pela má otimização e decisões de história
              ...
              entender nada e indignado com a situação."></Text>
          </section>
        ),
        media: {
          imagem: crysis,
