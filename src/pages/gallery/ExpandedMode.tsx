...
export const ExpandedMode = ({ media, title, description, onClose, handleNext, handlePrev }: expandedModoType) => {
  return (
      ...
      <div className="w-full relative">
        ...
        {media.youtube ? (
          <iframe
            ...
            allowFullScreen
            className=" min-h-[497px] w-full h-full object-cover border-2 border-white rounded-[3px]"></iframe>
        ) : media.imagem ? (
          <img src={media.imagem} alt="" className="w-full h-full object-cover border-2 border-white rounded-[3px]" />
        ) : undefined}
      </div>
